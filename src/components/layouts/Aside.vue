  ...
  <div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
      <div class="profile-info">
        ...
        <div class="user-info">
          <img src="/public/assets/img/90x90.jpg" alt="avatar">
      ...
      <ul class="list-unstyled menu-categories ps ps--active-y" id="accordionExample">
        <li class="menu active">
          <a href="#dashboard" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle collapsed">
            <div class="">
          ...
          <ul class="submenu recent-submenu list-unstyled collapse show" id="dashboard" data-parent="#accordionExample" style="">
            <router-link aria-haspopup="true" class="menu-item" tag="li" to="/category/index"><a class="menu-link">
              <i class="menu-bullet menu-bullet-dot">
                <span></span>
              </i>
              <span class="menu-text">عرض</span>
            </a></router-link>
            <router-link aria-haspopup="true" class="menu-item" tag="li" to="/category/create"><a class="menu-link">
              <i class="menu-bullet menu-bullet-dot">
                <span></span>
              </i>
              <span class="menu-text">إنشاء</span>
            </a></router-link>
          </ul>
        </li>
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: -700px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 700px; height: 346px; right: 249px;"><div class="ps__thumb-y" tabindex="0" style="top: 207px; height: 102px;"></div></div></ul>
